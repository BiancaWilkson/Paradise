...
///sent when an mmi/robobrain is alive, but is stuck as a brain without a borg/spiderbot shell and the like
#define COMSIG_CONSCIOUS_BRAIN_UNASSISTED "conscious_brain_unassisted"
///sent when a mmi/robobrain is put into any shell
#define COMSIG_CONSCIOUS_BRAIN_ASSISTED "conscious_brain_assisted"
